...
def ComputePvalue(reads, A, B, best_C, best_f, stutter_probs, method):
...
def ReadStutter(stutter_file):
    r"""Reading stutter parameter file

	Parameters
	----------
	stutter_file : string
	   Path of file that contains stutter parameters

	Returns
	-------
	stutter_dict : dictionary
	   Dictionary containing stutter parameter information
	"""
    stutter_dict = {}
...
def getargs(): # pragma: no cover
    ...
    filter_group.add_argument("--pmethod", help="Select the method for p value calculation"
                              "Options are SF or NORM", type=str, default="SF")
...
def main(args):
    ...
    for record in region:
        ...
        for i in range(len(samples)):
            ...
            pval = ComputePvalue(reads, A, B, best_C, best_f, stutter_probs, args.pmethod)

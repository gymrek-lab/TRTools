...
Note: PASS column is generated by dumpSTR or other filtering tools based on the set of parameters users want to filter out their TR calls on. 
PASS column therefore only serves to reflect whether any given locus meets the set filtering criteria or not.

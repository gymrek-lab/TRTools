...
def _HarmonizeGangSTRRecord(vcfrecord: cyvcf2.Variant):
    """
    Turn a cyvcf2 record object with GangSTR content into a TRRecord.
...
def _HarmonizeHipSTRRecord(vcfrecord: cyvcf2.Variant):
    """
    Turn a cyvcf2 record object with HipSTR content into a TRRecord.
...
def _HarmonizeAdVNTRRecord(vcfrecord: cyvcf2.Variant):
    """
    Turn a cyvcf2 record object with adVNTR content into a TRRecord.
...
def _HarmonizePopSTRRecord(vcfrecord: cyvcf2.Variant):
    """
    Turn a cyvcf2 record object with popSTR content into a TRRecord.
...
def _HarmonizeEHRecord(vcfrecord: cyvcf2.Variant):
    """
    Turn a cyvcf2 record object with EH content into a TRRecord.
...
class TRRecordHarmonizer:
    ...
    provide the cyvcf2.Variant yourself, use the top-level

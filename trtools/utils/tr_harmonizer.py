...
class TRRecord:
    ...
    def GetGenotypeIndicies(self) -> Optional[np.ndarray]:
        ...
        If the sample has fewer genotypes than the maximum ploidy of all
        samples, then the rows is padded with negative ones, so a haploid
        sample with gt '1' would be represented by the row [1, -1, 0].
        If the sample is a no call, then all the genotype columns will be
        negative ones, e.g. [-1, -1, 0]. Note: the value of the phasing
        ...
        Optional[np.ndarray]
            ...
            If there are no calls in this record, then return None instead
        """

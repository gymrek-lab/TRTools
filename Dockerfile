...
RUN pip3 install pybedtools pyvcf scipy
...
RUN wget -O GangSTR-2.3.tar.gz https://github.com/gymreklab/GangSTR/releases/download/v2.3/GangSTR-2.3.tar.gz
RUN tar -xzvf GangSTR-2.3.tar.gz
WORKDIR GangSTR-2.3
